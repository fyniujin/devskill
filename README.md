...
| tax-receipt-compliance | `tax-receipt-compliance/SKILL.md` | v2.5.0 | 财税合规全链路助手：发票OCR识别→真伪查验→报销单自动填充→对接审批系统。企业自主配置，数据本地处理。 |
...
| 版本 | 日期 | 本次更新 |
|------|------|---------|
| v2.5.0 | 2026-06-29 | 测试发布：验证统一发布脚本tongyifabu.ps1全流程（SkillHub/ClawHub/GitHub/Gitee） |
