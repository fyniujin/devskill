...
| tax-receipt-compliance | `tax-receipt-compliance/SKILL.md` | v2.6.5 | 财税合规全链路助手：发票OCR识别→真伪查验→报销单自动填充→对接审批系统。企业自主配置，数据本地处理。 |
...
| 版本 | 日期 | 本次更新 |
|------|------|---------|
| v2.6.5 | 2026-06-30 | [feat] 统一发布脚本 Step 3 自动同步到 GitHub/Gitee；新增校验逻辑 || v2.5.0 | 2026-06-29 | 测试发布 |
