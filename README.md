...
| dgngjx-skill | v3.8.0 | 多功能免费工具箱 - 图片处理、PDF转换、数据换算、文本工具、开发工具、视频工具、教育、生活娱乐、实用小工具、系统工具、AI办公。11大模块53个工具。v3.8 新增会议纪要生成器(ASR三级降级)+周报月报生成，优化系统资源监控(迁移PowerShell CIM)。 |
