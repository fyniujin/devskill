...
| gov-procurement-analyst | `gov-procurement-analyst/SKILL.md` | v3.5.1 | 政府采购全流程智能分析助手（15大模块，零配置开箱即用） | 政府采购全流程智能分析助手。覆盖商机发现、投标决策、文件编制、供应商背调、合规审计、 中标跟踪、资质管理、政策咨询、保证金管理、质疑投诉、合同分析、验收辅... |
