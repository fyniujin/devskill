...
```bash
# 扫描一个技能目录（文本输出）
python D:\skill\skill-security-scanner\scripts\audit.py "D:\skill\your-skill"

# 生成 JSON 报告
python D:\skill\skill-security-scanner\scripts\audit.py "D:\skill\your-skill" --format json

# 生成 HTML 报告并保存
python D:\skill\skill-security-scanner\scripts\audit.py "D:\skill\your-skill" --format html -o report.html

# 跳过更新检查
python D:\skill\skill-security-scanner\scripts\audit.py "D:\skill\your-skill" --skip-update
```
...
- "扫描这个 skill 有没有安全问题"
- "发布前检查 my-skill"
- "/skill-security-scanner skill_path"
