"""DouBao (ByteDance Volcengine) model endpoint."""
...
# DouBao uses Volcengine's Maas API, OpenAI-compatible endpoint
API_URL = "https://ark.cn-beijing.volces.com/api/v3/chat/completions"


class DouBaoAdapter(BaseAdapter):
    provider_name = "doubao"
    default_model = "ep-20240101-xxxxx"  # placeholder - user sets endpoint_id as model
    ...
    def chat(self, messages: List[ChatMessage], *,
        ...
        try:
            ...
            raise RuntimeError(
                f"[DouBao] HTTP {e.code}: {body[:200]}。请检查 api_key 和 endpoint_id。"
            ) from e
